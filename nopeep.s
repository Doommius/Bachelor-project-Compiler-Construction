...
factorial:                    # Start of body
    ...
    movq -8(t15), -8(t15)     # Used to get target for next instruction
    ...
    movq -8(t18), -8(t18)     # Used to get target for next instruction
...
main:                         # Start of body
    ...
    movq -8(%rbp), -8(%rbp)   # Used to get target for next instruction
