...
SRC = $(filter-out $(wildcard $(SRC_DIR)/scan_parse.c) $(wildcard $(SRC_DIR)/tests.c), $(wildcard $(MOD_DIR)/symbol_tree/%.c $(SRC_DIR)/main.c))
INC = $(INC_DIR) -I$(MOD_DIR)/symbol_tree/include/
OBJ = $(SRC:$(MOD_DIR)/symbol_tree/%.c=$(OBJ_DIR)/%.o)
