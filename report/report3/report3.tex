...
\lstinputlisting{../../src/tests/weeder/test_arithmetic_multiply.src}

\subsubsection{test_arithmetric_zero_division.src}
\lstinputlisting{../../src/tests/weeder/test_arithmetric_zero_division.src}

\subsubsection{test_if-else_boolean_expression.src}
\lstinputlisting{../../src/tests/weeder/test_if-else_boolean_expression.src}

\subsubsection{test_if-else_only_boolean.src}
\lstinputlisting{../../src/tests/weeder/test_if-else_only_boolean.src}

\subsubsection{test_no_return.src}
\lstinputlisting{../../src/tests/weeder/test_no_return.src}

\subsubsection{test_no_return_if.src}
\lstinputlisting{../../src/tests/weeder/test_no_return_if.src}

\subsubsection{test_no_return_multiple_functions.src}
\lstinputlisting{../../src/tests/weeder/test_no_return_multiple_functions.src}

\subsubsection{test_return_inside_outside.src}
\lstinputlisting{../../src/tests/weeder/test_return_inside_outside.src}

\subsubsection{test_return_not_enough.src}
\lstinputlisting{../../src/tests/weeder/test_return_not_enough.src}

\subsubsection{Typechecker Tests}
\subsubsection{test_arithmetic_typecheck.src}
\lstinputlisting{../../src/tests/typechecker/test_arithmetic_typecheck.src}

\subsubsection{test_arithmetic_wrong_types.src}
\lstinputlisting{../../src/tests/typechecker/test_arithmetic_wrong_types.src}

\subsubsection{test_array_index.src}
\lstinputlisting{../../src/tests/typechecker/test_array_index.src}

\subsubsection{test_function_arguments.src}
\lstinputlisting{../../src/tests/typechecker/test_function_arguments.src}

\subsubsection{test_function_arguments_to_many.src}
\lstinputlisting{../../src/tests/typechecker/test_function_arguments_to_many.src}

\subsubsection{test_function_arguments_too_few.src}
\lstinputlisting{../../src/tests/typechecker/test_function_arguments_too_few.src}

\subsubsection{test_function_exists.src}
\lstinputlisting{../../src/tests/typechecker/test_function_exists.src}

\subsubsection{test_function_return_type.src}
\lstinputlisting{../../src/tests/typechecker/test_function_return_type.src}

\subsubsection{test_function_wrong_return_type.src}
\lstinputlisting{../../src/tests/typechecker/test_function_wrong_return_type.src}

\subsubsection{test_recursive_pickup.src}
\lstinputlisting{../../src/tests/typechecker/test_recursive_pickup.src}

\subsubsection{test_recursive_pickup_2.src}
\lstinputlisting{../../src/tests/typechecker/test_recursive_pickup_2.src}
